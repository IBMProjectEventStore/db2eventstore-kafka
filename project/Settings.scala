...
object Settings extends Build {
  ...
  lazy val buildSettings = Seq(
    name := "db2eventstorekafka",
    normalizedName := "db2eventstorekafka",
    organization := "IBMProjectEventStore",
    organizationHomepage := Some(url("https://github.com/IBMProjectEventStore/db2eventstore-kafka")),
    scalaVersion := Versions.Scala,
    homepage := Some(url("https://github.com/IBMProjectEventStore/db2eventstore-kafka")),
